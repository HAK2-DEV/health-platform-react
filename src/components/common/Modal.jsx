        ...
        >
          ...
          {onPrev && (
            <button
              ...
              className="fixed left-2 sm:left-4 top-[58%] -translate-y-1/2 z-[70] w-10 h-10 flex items-center justify-center bg-white/20 hover:bg-white/60 text-gray-600 rounded-full shadow-md backdrop-blur-sm transition"
              title="이전"
              aria-label="이전 프로그램"
            >
          ...
          {onNext && (
            <button
              ...
              className="fixed right-2 sm:right-4 top-[58%] -translate-y-1/2 z-[70] w-10 h-10 flex items-center justify-center bg-white/20 hover:bg-white/60 text-gray-600 rounded-full shadow-md backdrop-blur-sm transition"
              title="다음"
              aria-label="다음 프로그램"
            >
