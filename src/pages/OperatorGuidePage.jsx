...
const STEPS = [
  ...
  },
  {
    ...
    captions: [
      ['+ 퀴즈 만들기', '퀴즈 템플릿에서 대상자·주제를 골라 만들기'],
  ...
  },
  {
    ...
    src: null,
    captions: [
      ['퀴즈 템플릿', '대상자·주제를 고르면 문항·정답·해설·출처가 준비돼 있어요'],
