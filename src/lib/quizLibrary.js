...
const GENERAL_TOPICS = [
  {
    ...
    questions: [
      ...
      mc("흡연 중독의 의학적 핵심으로 가장 알맞은 설명은?",
        ...
        "https://www.kdca.go.kr/menu.es?mid=a20205010900"),
  ...
  },
  {
    ...
    questions: [
      ...
      mc("러닝화를 교체할 시점을 점검하는 일반적 기준 주행 거리로 알맞은 것은?",
        ["50~100km", "500~800km", "2000km 이상", "거리와 상관없이 1년마다"], 1,
        "보통 500~800km 주행을 러닝화 교체 점검 기준으로 봅니다. 밑창이 닳거나 쿠션이 딱딱해지면 교체 신호입니다.",
        "https://www.rei.com/learn/expert-advice/replace-shoes.html"),
      mc("초보 러너가 과사용 부상을 피하기 위해 흔히 권장되는 주당 거리 늘리기 방식은?",
        ["매주 2배씩 늘린다", "주당 약 10% 안팎으로 서서히 늘린다", "한 번에 최대한 많이 늘린다", "거리는 늘리지 않는다"], 1,
        "너무 갑자기, 너무 많이가 과사용 부상의 흔한 원인입니다. 주당 거리 증가를 10% 안팎으로 제한하는 보수적 방식이 권장됩니다.",
        "https://www.betterhealth.vic.gov.au/health/healthyliving/running-and-jogging-preventing-injury"),
      ...
      ox("달리기 중 통증이 자세를 바꾸게 하거나 첫 1마일 이후에도 계속되면, 참고 계속 달리는 것이 좋다.", "X",
        ...
        "https://runnersconnect.net/injury-prevention/"),
  ...
  },
  {
    ...
    questions: [
      mc("성인에게 권장되는 일주일 유산소 운동 시간은 얼마일까요? (중강도 기준)",
        ["주 30분", "주 60분", "주 150분", "주 300분"], 2,
        "CDC는 성인에게 주당 중강도 유산소 150분(또는 고강도 75분)을 권합니다. 하루 30분씩 주 5일로 나눠도 됩니다.",
