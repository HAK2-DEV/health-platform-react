...
// 화면에 «반드시» 같이 렌더할 고지 — Play 건강 앱 정책(answer/13996367 「면책조항과 경고는 앱 내에 명확하게 표시」,
//   answer/16679511 「의료기기가 아니며 진단·처치·치료·예방하지 않음」 + 전문가 상담 안내) 요구.
//   마일스톤 수치는 일반 보건 안내 범위(질병관리청 금연길라잡이·WHO 금연 이익 자료)라 출처를 표기한다.
export const RECOVERY_DISCLAIMER = '일반적인 건강 정보이며 개인차가 있어요. 도담은 의료기기가 아니며 진단·치료·예방을 목적으로 하지 않아요. 건강 문제는 의사 등 전문가와 상담하세요.'
export const RECOVERY_SOURCE = '출처: 질병관리청 금연길라잡이 · WHO 금연 이익 안내(일반 정보)'
